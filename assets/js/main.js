// Mobile Menu
const mobileMenuBtn = document.querySelector(".header-logo");
const mobileMenu = document.querySelector(".desktop-menu-category-list");
...
mobileMenuBtn.onclick = () => {
    ...
    mobileMenu.classList.contains("active")
        ? mobileMenuBtn.src = "./assets/images/icon-close.svg"
        : mobileMenuBtn.src = "./assets/images/icon-menu.svg";
}
...
sliderImgSelector.forEach(el => {
    el.addEventListener("click", () => {
        sliderImg.src = `./assets/images/image-product-${el.getAttribute("value")}.jpg`;
    });
});
...
const previousImg = (img) => {
    if (counter > 1) {
        counter--;
        img.src = `/assets/images/image-product-${counter}.jpg`;
    } else {
        counter = 4;
        img.src = `/assets/images/image-product-${counter}.jpg`;
    }
...
sliderFocusImgSelector.forEach(el => {
    el.addEventListener("click", () => {
        sliderImgFocus.src = `/assets/images/image-product-${el.getAttribute("focus-value")}.jpg`;
        counter = el.id;
...
removeFromCartBtn.innerHTML = `<img src="./assets/images/icon-delete.svg" alt="">`;
...
const updateCart = () => {
    ...
    let htmlCode = 
        `<img class="cart__product--img" src="./assets/images/image-product-1-thumbnail.jpg" alt="">
